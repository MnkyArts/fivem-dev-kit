...
RULES = {
    ...
    "K008": ("warn", "ui_page in a plugin manifest (core owns the one CEF page)"),
    ...
    "K014": ("error", "UI-plugin manifest wiring (core_ui / files / client_script globs)"),
    "K015": ("error", "the built ui/dist: missing, stale or an invalid manifest.json"),
    "K016": ("error", "Core.UI.registerPage { script/style } -- removed with the UI platform"),
    "K017": ("warn", "plugin UI source using window.CoreUI, createApp or a NUI callback"),
